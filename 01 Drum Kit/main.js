...
var _user$project$Main$dataKey = function (key) {
	return A2(
		_elm_lang$html$Html_Attributes$attribute,
		'data-key',
...
var _user$project$Main$drumForKeyCode = function (keyCode) {
	...
	switch (_p0) {
		...
		case 83:
			return A3(_user$project$Main$Drum, 83, 'S', 'hihat');
		case 68:
			return A3(_user$project$Main$Drum, 68, 'D', 'kick');
		case 70:
			return A3(_user$project$Main$Drum, 70, 'F', 'openhat');
		case 71:
			return A3(_user$project$Main$Drum, 71, 'G', 'boom');
		case 72:
			return A3(_user$project$Main$Drum, 72, 'H', 'ride');
		case 74:
			return A3(_user$project$Main$Drum, 74, 'J', 'snare');
		case 75:
			return A3(_user$project$Main$Drum, 75, 'K', 'tom');
		case 76:
...
var _user$project$Main$view = function (model) {
	var drumNumbers = _user$project$Main$keyCodesIn(model);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			ctor: '::',
			_0: A2(
				_user$project$Main$drumBox,
				_user$project$Main$drumForKeyCode(65),
				drumNumbers),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Main$drumBox,
					_user$project$Main$drumForKeyCode(83),
					drumNumbers),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$Main$drumBox,
						_user$project$Main$drumForKeyCode(68),
						drumNumbers),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Main$drumBox,
							_user$project$Main$drumForKeyCode(70),
							drumNumbers),
						_1: {
							ctor: '::',
							_0: A2(
								_user$project$Main$drumBox,
								_user$project$Main$drumForKeyCode(71),
								drumNumbers),
							_1: {
								ctor: '::',
								_0: A2(
									_user$project$Main$drumBox,
									_user$project$Main$drumForKeyCode(72),
									drumNumbers),
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$Main$drumBox,
										_user$project$Main$drumForKeyCode(74),
										drumNumbers),
									_1: {
										ctor: '::',
										_0: A2(
											_user$project$Main$drumBox,
											_user$project$Main$drumForKeyCode(75),
											drumNumbers),
										_1: {
											ctor: '::',
											_0: A2(
												_user$project$Main$drumBox,
												_user$project$Main$drumForKeyCode(76),
												drumNumbers),
											_1: {ctor: '[]'}
										}
									}
